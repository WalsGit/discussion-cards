		...
		return (
            ...
            <h3>{app.translator.trans("walsgit_discussion_cards.admin.settings.general.cardOptions_title")}</h3>
              ...
              <div className="DC-DefaultImageSettings">
                ...
                {app.data.settings.walsgit_discussion_cards_default_image_path === null ? <div className="imgStub"></div> : <img src={app.forum.attribute("baseUrl") + "/assets/" + app.data.settings.walsgit_discussion_cards_default_image_path}/>}
